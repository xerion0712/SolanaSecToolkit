...
impl ReportGenerator {
    ...
    async fn build_report(
        ...
        let metadata = ReportMetadata {
            ...
            scsec_version: env!("CARGO_PKG_VERSION").to_string(),
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Generated on {{metadata.generated_at}} by scsec v{{metadata.scsec_version}}</p>
        </div>
...
**Tool Version:** scsec v{{metadata.scsec_version}}  
...
---
*Report generated by [scsec](https://github.com/hasip-timurtas/scsec)*
"#;
